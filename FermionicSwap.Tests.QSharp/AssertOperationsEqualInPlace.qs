...
// Copy of Microsoft's code with a one-line change to reset all qubits
// explicitly before releasing them and some namespace mangling
// so it compiles.
// Delete this file once the following issue is addressed:
// https://github.com/microsoft/qsharp-runtime/issues/1129
